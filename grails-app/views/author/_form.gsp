...
<div class="fieldcontain ${hasErrors(bean: authorInstance, field: 'info', 'error')} ">
	<label for="info">
		<g:message code="author.info.label" default="Info" />
		
	</label>
	<g:textField name="info" value="${authorInstance?.info}"/>
</div>
