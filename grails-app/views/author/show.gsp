...
<%@ page import="pl.espeo.bookshelf.Author" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-author" class="content scaffold-show" role="main">
			...
			<ol class="property-list author">
				...
				<g:if test="${authorInstance?.info}">
				<li class="fieldcontain">
					<span id="info-label" class="property-label"><g:message code="author.info.label" default="Info" /></span>
					
						<span class="property-value" aria-labelledby="info-label"><g:fieldValue bean="${authorInstance}" field="info"/></span>
