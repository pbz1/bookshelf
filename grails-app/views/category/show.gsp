			...
			<ol class="property-list category">
				...
				<li class="fieldcontain">
					<span id="book-label" class="property-label"><g:message code="category.book.label" default="Book" /></span>
						...
						<span class="property-value" aria-labelledby="book-label"><g:link controller="book" action="show" id="${categoryInstance?.book?.id}">${categoryInstance?.book?.encodeAsHTML()}</g:link></span>
